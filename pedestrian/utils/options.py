...
def get_args():
    ...
    parser.add_argument("--testfile", default='sota/Model_18.pth')
    ...
    parser.add_argument("--first_sdm_train_epoch", default=0, type=int)
    ...
    parser.add_argument("--weight_decay", type=float, default=1e-4) # 4e-5
