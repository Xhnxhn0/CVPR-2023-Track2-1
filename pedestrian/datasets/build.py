...
from .bases import ImageDataset, TextDataset, ImageTextDataset, ImageTextMLMDataset, ImageDataset_val, TextDataset_val

from .mydata import MYdata

__factory = {'MY-DATA':MYdata }
...
def build_dataloader(args,test=False ,tranforms=None):
    ...
    if args.training:
        ...
        ds = dataset.val 
        val_img_set = ImageDataset_val(ds['image_pids'], ds['img_paths'],
                                   ds['attributes'],
                                   val_transforms)
        val_txt_set = TextDataset_val(ds['caption_pids'],
                                  ds['captions'],
                                  ds['attributes'],
                                  text_length=args.text_length)
